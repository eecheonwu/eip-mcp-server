...
4. Include code snippets for complex algorithms or configuration files if helpful.
5. Provide a checkbox list `- [ ]` for every single task so a coding agent can check them off as they execute.
