...
# Resolve KNOWLEDGE_DIR relative to this file's location to avoid CWD issues
...
@mcp.tool()
def initialize_local_ssot(project_id: str) -> str:
    """
...
@mcp.tool()
def generate_security_plan() -> str:
...
@mcp.tool()
def synchronize_ssot(update_summary: str) -> str:
    """
